...
export const topCategoryMappings: { [key: string]: string[] } = {
  ...
  'Pantry': ['Pasta', 'Rice', 'Vinegar', 'Chocolate Chips', 'Couscous', 'Baking (flour, sugar,...)', 'Oil', 'Salt', 'Beans', 'Stock & Broth', 'Tomato Sauce'],
  'Snacks & Sweets': ['LU Ecolier', 'Donuts', 'Ice Cream', 'Chocolate Candies', 'Goldfish', 'Cookies', 'Marshmallows', 'Chips', 'Nutella Crackers', 'Nutella', 'Cereal Bars', 'Other Snacks', 'Cereal'],
  'Beverages': ['Red Bull', 'Beer/Cider', 'Coffee', 'Other Drinks'],
